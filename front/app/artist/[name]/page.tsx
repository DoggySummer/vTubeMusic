...
export default function ArtistPage({ params }: ArtistPageProps) {
  ...
  return (
    <div className="flex min-h-screen bg-black text-white p-4 gap-4">
      <div className="flex-1 overflow-hidden relative rounded-lg bg-[#121212] flex flex-col">
        ...
        <div className="relative w-full pt-20 px-8 pb-8 bg-linear-to-b from-[#535353] to-[#121212]">
          <div className="flex flex-col md:flex-row items-end gap-6 z-10 relative">
            ...
            <div className="shrink-0">
              <div className="relative w-48 h-48 md:w-60 md:h-60 rounded-full overflow-hidden shadow-2xl border-4 border-[#121212]/20">
